...
public class Software_export{
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            WritableSheet patent_ws = wwb.createSheet("软件著作权情况", 0);
    ...
    public void toexcel(WritableSheet ws)
    {
        try {
               ...
               Label labelname = new Label(1,1,"著作权名称",cellFormat2);
               Label labelnumber = new Label(2,1,"软件著作权登记号",cellFormat2);
               Label labelowner= new Label(3, 1, "著作权人",cellFormat2);//表示第
               ...
               Label labelyear= new Label(8, 1, "年份",cellFormat2);
