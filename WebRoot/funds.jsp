...
<hr />
<p align="center">&nbsp;</p>
<p align="center">通过该页面您可以查询科研项目经费的情况同时也可以向系统中添加一个科研项目经费的情况</p>
<hr />
<p align="center">&nbsp;</p>
<p align="right">请选择您所需要的服务：</p>
<form id="form1" name="form1" method="post" action="funds">
  <label>
  <div align="right">
    <select name="funds" id="funds">
      <option value="1">添加科研经费信息</option>
      <option value="2">查询科研经费信息</option>
    </select>
  </div>
  </label>
  <p>
