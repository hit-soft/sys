  ...
  <tr>
    ...
    <td width="939" nowrap="nowrap"><table width="1545" border="1" align="center">
      ...
      <tr id =tr2 >
        ...
        <td width="113" nowrap="nowrap">获奖类型</td>
        <td width="97" nowrap="nowrap">获奖等级</td>
        <td width="96" nowrap="nowrap">获奖时间</td>
        <td width="90" nowrap="nowrap">获奖人员</td>
        <td width="55" nowrap="nowrap">排名顺序</td>
...
<s:iterator value="l5"> <!-- l 为action 中 list -->
      <tr id =tr3>
        ...
        <td nowrap="nowrap"><s:url id="editURL" action="alone_priz">
		<s:param name="name" value="%{name}"></s:param>
		<s:param name="type" value="%{type}"></s:param>
		<s:param name="level" value="%{level}"></s:param>
		<s:param name="time" value="%{time}"></s:param>
