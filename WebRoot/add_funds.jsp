...
<table width="1049" height="586" border="0" align="center" cellpadding="5" cellspacing="5" id = table1>
  ...
  <tr>
    ...
    <td width="913"><form id="form1" name="form1" method="post" action="add_funds">
...
align="center" cellpadding="2" cellspacing="0" id="table2" >
      ...
      <tr>
        ...
        <td height="42"><input name="already" type="text" id="textfield1"  size="32" /></td>
        </tr>
      <tr>
        <td height="42">未到款(万元)：</td>
        <td height="42"><input name="non" type="text" id="textfield1"  size="32"/></td>
        </tr>
      <tr>
