...
mpmenu1.addItem(new mMenuItem(' 添加科研经费信息','http://hua-pc:8080/test_wlh/add_funds.jsp','self',false,'用户注册',null,'','','',''));
mpmenu1.addItem(new mMenuItem(' 更新科研经费信息','http://hua-pc:8080/test_wlh/update_funds.jsp','self',false,'用户登录',null,'','','',''));

mpmenu2=new mMenu('科研项目验收管理','/SoftDown/','self','','','','');
mpmenu2.addItem(new mMenuItem(' 添加科研项目验收信息','http://hua-pc:8080/test/add_funds.jsp','self',false,'系统程序',null,'','','',''));
mpmenu2.addItem(new mMenuItem(' 更新科研项目验收信息','/softdown/index.asp?CateID=2','self',false,'网络工具',null,'','','',''));

mpmenu3=new mMenu('软件著作权管理','/SoftSchool/','self','','','','');
mpmenu3.addItem(new mMenuItem(' 添加软件著作权','/SoftSchool/Index.Asp?CateID=1','self',false,'软件瞭望',null,'','','',''));
mpmenu3.addItem(new mMenuItem(' 更新软件著作权','/SoftSchool/Index.Asp?CateID=2','self',false,'精文荟萃',null,'','','',''));
mpmenu3.addItem(new mMenuItem(null,null,null,true));

mpmenu4=new mMenu(' 专利管理','/Develop/','self','','','','');
mpmenu4.addItem(new mMenuItem(' 添加专利','/Develop/Index.Asp?CateID=1','self',false,'网页设计',null,'','','',''));
mpmenu4.addItem(new mMenuItem(' 更新专利','/Develop/Index.Asp?CateID=10','self',false,'.Net专栏',null,'','','',''));
mpmenu4.addItem(new mMenuItem(null,null,null,true));
mpmenu5=new mMenu('获奖情况管理','/Lunwen/','self','','','','');
mpmenu5.addItem(new mMenuItem(' 增加获奖情况','/Lunwen/Index.Asp?CateID=1','self',false,'学科教学',null,'','','',''));
mpmenu5.addItem(new mMenuItem(' 更新获奖情况','/Lunwen/Index.Asp?CateID=2','self',false,'教学管理',null,'','','',''));
...
mpmenu6.addItem(new mMenuItem(' 增加出版专著','/bbs/usersms.asp','self',false,'用户短消息',null,'','','',''));
mpmenu6.addItem(new mMenuItem(' 修改出版专著','/bbs/favlist.asp','self',false,'',null,'','','',''));
mpmenu6.addItem(new mMenuItem(null,null,null,true));
mpmenu7=new mMenu('学术团体兼职情况管理','','self','','','','');
mpmenu7.addItem(new mMenuItem(' 增加学术团体兼职情况','/club/bank/Index.asp','self',false,'e 时代银行',null,'','','',''));
mpmenu7.addItem(new mMenuItem(' 修改学术团体兼职情况','/club/saima/horse.asp','self',false,'赛马',null,'','','',''));
mpmenu8=new mMenu('国内外进修及学习管理','/iiTest/','self','','','','');
mpmenu8.addItem(new mMenuItem(' 增加国内外进修及学习信息','/iiTest/Index.Asp?CateID=1','self',false,'历史知识',null,'','','',''));
mpmenu8.addItem(new mMenuItem(' 修改国内外进修及学习信息','/iiTest/Index.Asp?CateID=2','self',false,'电脑知识',null,'','','',''));
mpmenu9=new mMenu('国际合作情况管理','','self','','','','');
mpmenu9.addItem(new mMenuItem(' 增加国际合作情况信息','/WebMail/','self',false,'',null,'','','',''));
mpmenu9.addItem(new mMenuItem(' 修改国际合作情况信息','/GuestBook/','self',false,'',null,'','','',''));
mpmenu10=new mMenu('其他系统功能','','self','','','','');
mpmenu10.addItem(new mMenuItem(' 综合分析','http://hua-pc:8080/test_wlh/show_author.jsp','self',false,'互联网工具',null,'','','',''));
mpmenu10.addItem(new mMenuItem(' 导出到excel','http://hua-pc:8080/test_wlh/show_author.jsp','self',false,'常用工具',null,'','','',''));
...
<tr>
    <td align="center"><div id ="banner2"><s:url id="editURL" action="action3">
		...
		<s:a href="%{editURL}">工作量综合分析</s:a></div></td>
  </tr>
  
  <tr>
    <td align="center"><div id ="banner2"><s:url id="editURL" action="action4">
		</s:url>
		<s:a href="%{editURL}">导出到excel表格</s:a></div></td>
  </tr>
