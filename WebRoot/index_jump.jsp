...
<div id="banner">
<ul id="nav">
    <li><s:url id="editURL" action="funds">
		<s:param name="fuck" value="1"></s:param>
		</s:url>
		<s:a href="%{editURL}">科研经费到款情况</s:a></li>
    <li><s:url id="editURL" action="accept">
		<s:param name="fuck" value="1"></s:param>
		</s:url>
		<s:a href="%{editURL}">科研项目验收情况</s:a></li>
    <li><s:url id="editURL" action="software">
		<s:param name="fuck" value="1"></s:param>
		</s:url>
		<s:a href="%{editURL}">软件著作权管理</s:a></li>
    <li><s:url id="editURL" action="patent">
		<s:param name="fuck" value="1"></s:param>
		</s:url>
		<s:a href="%{editURL}">专利管理</s:a></li>
    <li><s:url id="editURL" action="priz">
		<s:param name="fuck" value="1"></s:param>
		</s:url>
		<s:a href="%{editURL}">获奖情况管理</s:a></li>
    <li><s:url id="editURL" action="publ">
		<s:param name="fuck" value="1"></s:param>
		</s:url>
		<s:a href="%{editURL}">出版专著管理</s:a></li>
    <li><s:url id="editURL" action="team">
		<s:param name="fuck" value="1"></s:param>
		</s:url>
		<s:a href="%{editURL}">学术团体兼职情况</s:a></li>
    <li><s:url id="editURL" action="study">
		<s:param name="fuck" value="1"></s:param>
		</s:url>
		<s:a href="%{editURL}">国内外进修及学习</s:a></li>
    <li><s:url id="editURL" action="coope">
		<s:param name="fuck" value="1"></s:param>
		</s:url>
