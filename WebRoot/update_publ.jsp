...
<table width="1049" height="586" border="0" align="center" cellpadding="5" cellspacing="5" id = table1>
  ...
  <tr>
    ...
    <td width="913"><form id="form1" name="form1" method="post" action="update_publ">
...
align="center" cellpadding="2" cellspacing="0" id="table2" >
      ...
      <tr>
        ...
        <td height="42"><input name="press" type="text" id="textfield1" size="32" value="${press}"/></td>
        </tr>
      <tr>
