...
<table width="1049" height="586" border="0" align="center" cellpadding="5" cellspacing="5" id = table1>
  ...
  <tr>
    ...
    <td width="913"><form id="form1" name="form1" method="post" action="update_team">
...
align="center" cellpadding="2" cellspacing="0" id="table2" >
      ...
      <tr>
        ...
        <td width="301" height="42"><input name="name" type="text" id="textfield1" size="42" value="${name}"  readonly/></td>
        <td width="465" rowspan="9"><label for="end"><img src="add1.jpg" width="450" height="378" /></label></td>
        </tr>
      <tr>
        <td height="42">担任职务：</td>
        <td height="42"><input name="post" type="text" id="textfield1" size="42" value="${post}" readonly/></td>
        </tr>
      
      <tr>
        <td height="42">任职开始时间：</td>
        <td height="42"><input name="start" type="text" id="textfield1" size="42" value="${start}"/></td>
        </tr>
      <tr>
        <td height="42">任职结束时间：</td>
        <td height="42"><input name="end" type="text" id="textfield1" size="42" value="${end}"/></td>
        </tr>
      <tr>
        <td height="42">兼职人员姓名：</td>
        <td height="42"><input name="person" type="text" id="textfield1" size="42" value="${person}"/></td>
        </tr>
      <tr>
      ...
      <tr>
        <td height="42">年份：</td>
        <td height="42"><input name="year" type="text" id="textfield1" size="42" value="${year}"  readonly/></td>
        </tr>
      <tr>
        <td height="42">&nbsp;</td>
