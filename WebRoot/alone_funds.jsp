...
<table width="1049" height="586" border="0" align="center" cellpadding="5" cellspacing="5" id = table1>
  ...
  <tr>
    ...
    <td width="913"><form id="form1" name="form1" method="post" action="myadd_funds">
...
align="center" cellpadding="2" cellspacing="0" id="table2" >
      ...
      <tr>
        ...
        <td height="42"><input name="source" type="text" id="textfield1" size="32" value="${source}" readonly/></td>
        </tr>
      <tr>
        <td height="42">项目负责人：</td>
        <td height="42"><input name="leader" type="text" id="textfield1" size="32" value="${leader}" readonly/></td>
        </tr>
      <tr>
        <td height="42">开始时间：</td>
        <td height="42"><input name="start" type="text" id="textfield1" size="32" value="${start}" readonly/></td>
        </tr>
      <tr>
        <td height="42">结束时间：</td>
        <td height="42"><input name="end" type="text" id="textfield1" size="32" value="${end}" readonly/></td>
        </tr>
      <tr>
        <td height="42">合同额(万元)：</td>
        <td height="42"><input name="contract"  type="text" id="textfield1" size="32" value="${contract}" readonly/></td>
        </tr>
      <tr>
        <td height="42">已到款(万元)：</td>
        <td height="42"><input name="already" type="text" id="textfield1"  size="32" value="${already}" readonly/></td>
        </tr>
      <tr>
        <td height="42">未到款(万元)：</td>
        <td height="42"><input name="non" type="text" id="textfield1"  size="32" value="${non}" readonly/></td>
        </tr>
      <tr>
        <td height="42">课题合同号：</td>
        <td height="42"><input name="number" type="text" id="textfield1"  size="32" value="${number}" readonly/></td>
        </tr>
      <tr>
        <td height="42">人员：</td>
