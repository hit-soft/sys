...
<table width="1049" height="586" border="0" align="center" cellpadding="5" cellspacing="5" id = table1>
  ...
  <tr>
    ...
    <td width="913"><form id="form1" name="form1" method="post" action="add_priz">
...
align="center" cellpadding="2" cellspacing="0" id="table2" >
      ...
      <tr>
        ...
        <td height="42"><input name="type"  type="text" id="textfield1" size="32" /></td>
        </tr>
      <tr>
      ...
      <tr>
        <td height="42">获奖人员1：</td>
        <td height="42"><input name="person" type="text" id="textfield1"  size="32"/></td>
        </tr>
      <tr>
        <td height="42">获奖人员2：</td>
         <td height="42"><input name="person" type="text" id="textfield1"  size="32"/></td>
        </tr>
      <tr>
        <td height="42">获奖人员3：</td>
        <td height="42"><input name="person" type="text" id="textfield1"  size="32"/></td>
        </tr>
      <tr>
        <td height="42">获奖人员4：</td>
        <td height="42"><input name="person" type="text" id="textfield1"  size="32"/></td>
        </tr>
      <tr>
        <td height="42">获奖人员5：</td>
         <td height="42"><input name="person" type="text" id="textfield1"  size="32"/></td>
        </tr>
      <tr>
        <td height="42">获奖人员6：</td>
        <td height="42"><input name="person" type="text" id="textfield1"  size="32"/></td>
        </tr>
      <tr>
        <td height="42">获奖人员7：</td>
        <td height="42"><input name="person" type="text" id="textfield1"  size="32"/></td>
        </tr>
      <tr>
        <td height="42">获奖人员8：</td>
         <td height="42"><input name="person" type="text" id="textfield1"  size="32"/></td>
        </tr>
      <tr>
        <td height="42">获奖人员9：</td>
        <td height="42"><input name="person" type="text" id="textfield1"  size="32"/></td>
        </tr>
      <tr>
        <td height="42">获奖人员10：</td>
        <td height="42"><input name="person" type="text" id="textfield1"  size="32"/></td>
        </tr>
      <tr>
        <td height="42">时间：</td>
