...
<table width="1049" height="586" border="0" align="center" cellpadding="5" cellspacing="5" id = table1>
  ...
  <tr>
    ...
    <td width="913"><form id="form1" name="form1" method="post" action="myadd_accept">
...
align="center" cellpadding="2" cellspacing="0" id="table2" >
      ...
      <tr>
        ...
        <td height="42"><input name="time" type="text" id="textfield1" size="32" value="${time}"/></td>
        </tr>
      <tr>
        <td height="42">验收单位：</td>
        <td height="42"><input name="org" type="text" id="textfield1"  size="32" value="${org}"  readonly/></td>
        </tr>
      <tr>
      ...
      <tr>
        ...
        <td height="42"><input name="card" type="text" id="textfield1" size="32" value="${card}"  readonly/></td>
        </tr>
      <tr>
        <td height="42">人员：</td>
      ...
      <tr>
        <td height="42">备注：</td>
        <td height="42"><input name="remark" type="text" id="textfield1"  size="32" value = "${remark}" readonly/></td>
        </tr>
      <tr>
