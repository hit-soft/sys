...
<table width="1049" height="620" border="0" align="center" cellpadding="5" cellspacing="5" id = table1>
  ...
  <tr>
    ...
    <td width="939" nowrap="nowrap"><table width="1545" border="1" align="center">
      <tr id =tr1>
        <td colspan="18">软件专利信息</td>
        </tr>
      <tr id =tr2 >
        <td width="104" nowrap="nowrap">著作权名称</td>
        <td width="113" nowrap="nowrap">著作权登记号</td>
        <td width="97" nowrap="nowrap">著作权人</td>
...
<s:iterator value="l7"> <!-- l 为action 中 list -->
      <tr id =tr3>
        ...
        <td nowrap="nowrap"><s:url id="editURL" action="del_software">
        ...
        <td nowrap="nowrap"><s:url id="editURL" action="upp_software">
        ...
        <td nowrap="nowrap"><s:url id="editURL" action="alone_software">
		<s:param name="name" value="%{name}"></s:param>
		<s:param name="number" value="%{number}"></s:param>
		<s:param name="owner" value="%{owner}"></s:param>
		<s:param name="org" value="%{org}"></s:param>
